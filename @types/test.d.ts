...
declare module 'node:test' {
     ...
     */
    const test: Test<TestContext> & {
        it: Test<TestContext>;
        describe: Test<SuiteContext>;
        skip: Test<TestContext>;
        /**
         * Shorthand for marking a test as `TODO`, same as `test([name], { todo: true }[, fn])`.
         * @since v20.2.0
         */
        todo: Test<TestContext>;
        only: Test<TestContext>;
    };
    /**
     * Shorthand for `test()`.
     *
     ...
     * @return `undefined`.
     */
    const describe: Test<SuiteContext> & {
        skip: Test<TestContext>;
        /**
         * Shorthand for marking a test as `TODO`, same as `test([name], { todo: true }[, fn])`.
         * @since v20.2.0
    ...
    /**
     * The type of the function under suite declaring all subtests and subsuites.
     * The first argument to this function is a {@link SuiteContext} object.
     */
    type SuiteFn = ((s: SuiteContext, done: (result: any) => void) => void) | ((t?: SuiteContext) => Promise<void>);
    /**
     * The type of the async function under suite declaring all subtests and subsuites.
     * The first argument to this function is a {@link SuiteContext} object.
     */
    type SuiteFn = (s: SuiteContext, done: (result: any) => void) => void
    type AsyncSuiteFn = (s: SuiteContext) => Promise<void>;
    ...
    type TestFn<Context> = (t: Context, done: (result?: any) => void) => void
    type AsyncTestFn<Context> = (t: Context) => Promise<void>;
    interface Test<Context> {
        (name?: string, options?: TestOptions, fn?: TestFn<Context>): Promise<void>;
        (name?: string, options?: TestOptions, fn?: AsyncTestFn<Context>): Promise<void>;
        (name?: string, fn?: TestFn<Context>): Promise<void>;
        (name?: string, fn?: AsyncTestFn<Context>): Promise<void>;
        (options?: TestOptions, fn?: TestFn<Context>): Promise<void>;
        (options?: TestOptions, fn?: AsyncTestFn<Context>): Promise<void>;
        (fn?: TestFn<Context>): Promise<void>;
        (fn?: AsyncTestFn<Context>): Promise<void>;
    }
    ...
    export { test as default, test, describe, it, before, after, beforeEach, afterEach,  run, mock };
}
